...
var MONGODB = env.get('MONGODB').required().asString();
var fn = function () { return __awaiter(void 0, void 0, void 0, function () {
    var mongoClient;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, new mongodb_1.MongoClient(MONGODB).connect()];
            case 1:
                mongoClient = _a.sent();
            ...
            case 2:
                ...
                return [4 /*yield*/, mongoClient.db().collection('user').insertOne({
